...
const useBurger = () => {
  useConsumableItem(hunger, setHunger, "Burger", burger, setBurger, Burger, setVisible);
};

const useTaco = () => {
  useConsumableItem(hunger, setHunger, "Taco", taco, setTaco, Taco, setVisible);
};

const useIceCream = () => {
  useConsumableItem(hunger, setHunger, "Ice Cream", iceCream, setIceCream, IceCream, setVisible);
};

const useCookie = () => {
  useConsumableItem(hunger, setHunger, "Cookie", cookie, setCookie, Cookie, setVisible);
};

const useBeer = () => {
  useConsumableItem(thirst, setThirst, "Beer", beer, setBeer, Beer, setVisible);
};
